self.defaults = {
  'types': '^(?:(?:text(?:area)?)|(?:password)|(?:select-(?:(?:one)|(?:multiple)))|(?:checkbox)|(?:radio)|(?:email)|(?:url)|(?:number)|(?:month)|(?:week)|(?:tel)|(?:file)|(?:textarea))$'
};
...
self.defaults.profile = {
  ...
  'email': 'ranjithkumar@chargebackgurus.com',
  'title': 'Mr.',
  'gender': 'male',
  'age': '30',
...
self.defaults.rules = {
  ...
  'user-name': {
    'field-rule': '(?:(?:username)|(?:user_id)|(?:membername))(?!\\w*pass)',
    'site-rule': '(?:)'
  },
  'home': {
    'field-rule': '(?:(?:Home)|(?:home)|(?:user_id)|(?:membername))(?!\\w*pass)',
    'site-rule': '(?:)'
  },
  'title': {
  ...
  'phone': {
    'field-rule': '(?:phone)|(?:tel)|(?:phon)|(?:mob)|(?:phoneNo)',
    'site-rule': '(?:)'
  },
